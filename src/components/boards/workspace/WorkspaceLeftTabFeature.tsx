...
function WorkspaceLeftTabFeature(props: Props) {
   return (
      <div
         className={`flex text-sm items-center justify-between px-5 py-1 bg-slate-300 bg-clip-padding backdrop-filter backdrop-blur-sm bg-opacity-0 hover:bg-opacity-20 `}
      >
