...
function WorkspaceLeftPreviewItem() {
   return (
      <div className='relative group px-2 flex items-center justify-between w-full text-sm py-[6px] bg-slate-500 bg-clip-padding backdrop-filter backdrop-blur-sm bg-opacity-0 hover:bg-opacity-20 rounded-sm cursor-pointer'>
         ...
         <div className='absolute right-[4px] w-fit items-center justify-center hidden group-hover:flex'>
            <div className='p-1 bg-slate-400 bg-clip-padding backdrop-filter backdrop-blur-sm bg-opacity-0 hover:bg-opacity-40 rounded-sm cursor-pointer'><BiDotsHorizontalRounded /></div>
            <div className='p-1 bg-slate-400 bg-clip-padding backdrop-filter backdrop-blur-sm bg-opacity-0 hover:bg-opacity-40 rounded-sm cursor-pointer'><AiOutlineStar /></div>
         </div>
      </div>
   )
}
