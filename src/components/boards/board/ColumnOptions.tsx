   ...
   return (
      <div
         ...
         <div className='relative mx-1'>
            <h1 className='text-center text-sm font-semibold py-2'>List actions</h1>
            <span
               onClick={() => {
                  props.setShowActions({ show: false, tab: '' })
               }}
               className='p-2 cursor-pointer absolute right-0 top-0 rounded-md hover:bg-slate-100'><RiCloseLine /></span>
         </div>
         <ul className='w-full text-sm'>
            <li
               ...
               className='cursor-pointer w-full hover:bg-slate-200 py-1 px-4'>Add card...</li>
            <li
               onClick={() => {
