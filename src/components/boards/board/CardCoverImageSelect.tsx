      ...
      <div>
         ...
         <div className='grid grid-cols-2 gap-1'>
            ...
            <CardCover
               setCoverCard={props.setCoverCard}
               cover={props.cover}
               image={{ ntn: 5, type: "image" }}
            />
            <CardCover
               setCoverCard={props.setCoverCard}
               cover={props.cover}
               image={{ ntn: 6, type: "image" }}
            />
            <CardCover
               setCoverCard={props.setCoverCard}
               cover={props.cover}
               image={{ ntn: 7, type: "image" }}
            />
            <CardCover
               setCoverCard={props.setCoverCard}
               cover={props.cover}
               image={{ ntn: 8, type: "image" }}
            />
            <CardCover
               setCoverCard={props.setCoverCard}
               cover={props.cover}
               image={{ ntn: 9, type: "image" }}
            />
            <CardCover
               setCoverCard={props.setCoverCard}
               cover={props.cover}
               image={{ ntn: 10, type: "image" }}
            />
            <CardCover
               setCoverCard={props.setCoverCard}
               cover={props.cover}
               image={{ ntn: 11, type: "image" }}
            />
            <CardCover
               setCoverCard={props.setCoverCard}
               cover={props.cover}
               image={{ ntn: 12, type: "image" }}
            />
         </div>
      </div>
   )
