   ...
   return (
      ...
      >
         <div className='aspect-square w-full flex items-center justify-start max-w-[45px] relative rounded-md bg-gradient-to-r from-sky-500 to-indigo-500'>
            <span className='absolute top-[50%] left-[50%] translate-x-[-50%] translate-y-[-50%] text-white text-2xl font-semibold'>
               {props.workspace?.name.toUpperCase().charAt(0)}
            </span>
         </div>
         <p className='truncate whitespace-nowrap overflow-hidden ml-3 font-semibold text-gray-600'>
