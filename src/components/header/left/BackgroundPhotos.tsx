      ...
      <div>
         <div className='relative pb-2'>
            <span
               ...
               className='absolute left-0 top-0 p-2 hover:bg-slate-100 rounded-md cursor-pointer'
            >
               <GrPrevious />
            </span>
            ...
            <span
               ...
               className='absolute right-0 top-0 p-2 hover:bg-slate-100 rounded-md cursor-pointer'
            >
               <GrClose />
            </span>
         </div>
         <div className='grid grid-cols-2 gap-1 max-h-[70vh] overflow-y-scroll'>
            <Background
               ntn={1}
               type='image'
               setSelectBg={props.setSelectBg}
               selectBg={props.selectBg}
            />
            <Background
               ntn={2}
               type='image'
