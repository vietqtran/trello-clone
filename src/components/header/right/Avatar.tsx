            ...
            <div className='flex items-center justify-start px-4 mb-2'>
               <div>
                  <div className='relative p-5 w-fit bg-blue-500 rounded-full'>
                     <span className='font-semibold text-2xl text-white absolute top-[50%] left-[50%] translate-x-[-50%] translate-y-[-50%] '>V</span>
                  </div>
               </div>
               <div className='w-[170px] ml-1 flex flex-col items-start justify-center'>
                  <p className='text-sm w-full truncate whitespace-nowrap'>Namjsssssssssssssssssssssssshd</p>
                  <p className='text-xs w-full truncate whitespace-nowrap'>asaddddddddddddsssssssssssdsdad</p>
               </div>
            </div>
            <div className='p-4 py-2 my-1 border-t-2 cursor-pointer hover:bg-slate-200'>Log out</div>
         </div>}
      </div>
   )
}
