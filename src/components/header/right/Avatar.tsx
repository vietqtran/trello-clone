   ...
   return (
      ...
      >
         <div className='p-1 hover:bg-slate-200 rounded-full cursor-pointer ml-1'>
            ...
            >
               <span className='absolute top-[50%] left-[50%] translate-y-[-50%] translate-x-[-50%] text-white text-xs'>
                  {props.user?.email?.toUpperCase().charAt(0)}
               </span>
            </div>
         </div>

         {show && (
            <div className='text-black bg-white min-w-[240px] drop-menu-shadow right-0 top-[45px] absolute rounded-md'>
               ...
               <div className='flex items-center justify-start px-4 mb-2'>
                  <div>
                     <div className='relative p-5 w-fit bg-gradient-to-r from-sky-500 to-indigo-500 rounded-full'>
                        <span className=' font-semibold text-2xl text-white absolute top-[50%] left-[50%] translate-x-[-50%] translate-y-[-50%] '>
                           {props.user?.email?.toUpperCase().charAt(0)}
                        </span>
                     </div>
                  </div>
                  <div className='w-[170px] ml-1 flex flex-col items-start justify-center'>
                     <p className='text-sm w-full truncate whitespace-nowrap'>
                        {props.user.email}
                     </p>
                  </div>
               </div>
               <div
                  ...
                  className='p-4 py-2 my-1 border-t-2 cursor-pointer hover:bg-slate-200'
               >
                  Log out
               </div>
            </div>
